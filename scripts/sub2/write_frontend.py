...
def ropen(p): return open(p, "r", encoding="utf-8")
def wopen(p): return open(p, "w", encoding="utf-8")
def aopen(p): return open(p, "a", encoding="utf-8")
...
# Add View button column — find the closing </tr> after the last td
old_td = '                    </td>\n                  </tr>\n                );\n              })}'
